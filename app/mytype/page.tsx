  ...
  return (
    <div className="min-h-screen bg-[#E5E7EB] font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl flex items-start gap-3">
        ...
        <button
          onClick={() => router.back()}
          className="mt-2 flex-shrink-0 w-12 h-12 bg-white rounded-full flex items-center justify-center text-gray-700 transition-all active:scale-95"
        >
                ...
                {result ? (
                  ...
                  <div className="bg-white p-6 flex flex-col gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      >
                        <span className="text-xl font-black tracking-wide" style={{ color: GROUP_COLORS[result.group] }}>
                          {result.fullCode}
                        </span>
                      </div>
                      <div>
                        <p className="text-xs text-gray-400 font-medium">ประเภทบุคลิกภาพการทำงาน</p>
                        <p className="text-xl font-black text-[#4B3E7A]">{result.fullCode}</p>
