      ...
      <div className="bg-white w-full max-w-[500px] rounded-[24px] overflow-hidden shadow-2xl flex flex-col items-center p-8 md:p-12">
        ...
        <div className="w-full flex flex-col gap-3">
          <button onClick={handleSignIn} disabled={loading}
            className="w-full bg-[#607D8B] text-white py-4 rounded-[20px] font-bold text-lg hover:brightness-95 transition-all shadow-md active:scale-95 disabled:opacity-60">
