      ...
      <div className="bg-white w-full max-w-[600px] rounded-[24px] p-8 md:p-12 shadow-2xl flex flex-col gap-6">
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <button onClick={handleNext} disabled={loading}
            className="bg-[#2D3E50] text-white flex items-center gap-3 px-8 py-3 rounded-2xl hover:bg-[#1E293B] transition-all active:scale-95 shadow-lg group disabled:opacity-60">
