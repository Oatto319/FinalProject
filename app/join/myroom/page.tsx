        ...
        <div className="bg-white rounded-[40px] overflow-hidden shadow-sm min-h-[700px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 p-8 bg-gray-200/50 min-h-[600px]">
            ...
            <div className="md:col-span-6 flex flex-col gap-6">
              ...
              {/* Huge Ready Button */}
              <button className="mt-auto w-full bg-[#7096D1] text-white py-8 rounded-[30px] font-black text-5xl shadow-[0_10px_0_0_#4A6FA5] hover:shadow-[0_5px_0_0_#4A6FA5] hover:translate-y-[5px] transition-all active:shadow-none active:translate-y-[10px] uppercase tracking-[0.2em]">
                READY
              </button>
            </div>
