        ...
        <div className="md:col-span-5 flex flex-col gap-6">
          ...
          <div className="flex gap-4 mt-auto">
            ...
            <button
              ...
              className="flex-2 bg-[#2D3E50] text-white py-4 px-12 rounded-2xl font-bold text-xl shadow-md flex items-center justify-center gap-3 hover:bg-[#1E293B] transition-colors">
